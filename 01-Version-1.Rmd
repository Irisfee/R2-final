...
```{r data}
# Cam: I really liked that you figured out all of your paths ahead of time! I also found your use of dir in the next block ingenious. I did note that `full.names` argument in the `list.files()` function may be able to cut out a couple of steps in this and the following block and remove the need to figure out the the paths ahead of time. 
